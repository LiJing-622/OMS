  ...
  const routes = [
    {
      ...
      childRoutes: [
        ...
        },
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], (require) => {
              registerModel(app, require('./models/patientVerify'))
        ...
        },
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], (require) => {
              registerModel(app, require('./models/microcode'))
              cb(null, require('./routes/microcode/'))
            }, 'microcode')
          },
        },
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], (require) => {
              registerModel(app, require('./models/capitalAccount'))
              cb(null, require('./routes/capitalAccount/'))
            }, 'capitalAccount')
          },
        },
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], (require) => {
              registerModel(app, require('./models/particulars'))
              cb(null, require('./routes/particulars/'))
            }, 'particulars')
          },
        },
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], (require) => {
              registerModel(app, require('./models/cashManagement'))
              cb(null, require('./routes/cashManagement/'))
            }, 'cashManagement')
          },
        },
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], (require) => {
              registerModel(app, require('./models/cashManagement'))
              cb(null, require('./routes/cashManagement/edit'))
            })
          },
        },
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], (require) => {
              registerModel(app, require('./models/cashRefund'))
              cb(null, require('./routes/cashRefund/'))
            }, 'cashRefund')
          },
        },
        {
        ...
        // 注销管理
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], (require) => {
              registerModel(app, require('./models/logoutAdmin'))
              cb(null, require('./routes/logoutAdmin'))
            })
          },
        },
        // 注销管理详情
        {
          path: '/logoutAdmin/edit/:code',
          getComponent (nextState, cb) {
            require.ensure([], (require) => {
              registerModel(app, require('./models/logoutAdmin'))
              cb(null, require('./routes/logoutAdmin/edit'))
            })
          },
        },
        // 注销记录
        {
          path: '/logoutAdminRecord',
          getComponent (nextState, cb) {
            require.ensure([], (require) => {
              registerModel(app, require('./models/logoutAdminRecord'))
              cb(null, require('./routes/logoutAdminRecord'))
            })
          },
        },
        {
          path: '/logoutAdminRecord/edit/:code',
          getComponent (nextState, cb) {
            require.ensure([], (require) => {
              registerModel(app, require('./models/logoutAdminRecord'))
              cb(null, require('./routes/logoutAdminRecord/edit'))
            })
          },
        },
        // 分润
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], (require) => {
              registerModel(app, require('./models/shareBenefit'))
              cb(null, require('./routes/shareBenefit'))
            })
          },
        },
        // 视频 用户
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], (require) => {
              registerModel(app, require('./models/videoUser'))
              cb(null, require('./routes/videoUser'))
            })
          },
        },
        // 视频医生
        ...
        //   getComponent (nextState, cb) {
        //     require.ensure([], (require) => {
        //       registerModel(app, require('./models/videoDoctor'))
        //       cb(null, require('./routes/videoDoctor'))
        //     })
        //   },
        // },
        // 二维码
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], (require) => {
              registerModel(app, require('./models/codeQR'))
              cb(null, require('./routes/codeQR'))
            })
          },
        },
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], (require) => {
              registerModel(app, require('./models/codeQR'))
              cb(null, require('./routes/codeQR/edit'))
            })
          },
        },
        {
