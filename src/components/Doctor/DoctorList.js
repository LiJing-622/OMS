    ...
    },
    {
      ...
      render: (text, record) => {
        ...
        return (
          type === '1' ?
            <span>
              <Link to={{ pathname: `/doctors/edit/${code}`, query: { currentList: realPagination.current } }} >详情</Link>
          ...
          :
            <span>
              <Link to={{ pathname: `/doctors/editUndone/${code}`, query: { currentList: realPagination.current } }} >详情</Link>
