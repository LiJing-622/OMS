  ...
  return (
    <Spin spinning={confirmLoading}>
      <Form>
        <Row>
          <Col span={24} >
            {/* <Link to="/doctors"><Button type="default" size="large" style={{ marginBottom: '30px' }} onClick={changeType}>返回</Button></Link> */}
            <Button type="default" size="large" style={{ marginBottom: '30px' }} onClick={changeType}>返回</Button>
